...
/// A lively animated panda companion that floats, wobbles, and blinks.
...
class _AnimatedPandaCompanionState extends State<AnimatedPandaCompanion>
  ...
  void _handleTap() {
    ...
    try {
      ...
      // No-op if platform does not support haptics.
    }
    widget.onTap?.call();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final accent = widget.persona.accentColor.withValues(alpha: 0.6);
    ...
    Widget pandaAvatar = GestureDetector(
      ...
      child: AnimatedBuilder(
                                ...
                                child: Transform.scale(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        BoxShadow(
                                          color: sparkle.color.withValues(alpha: 0.5),
        ...
        child: Image.asset(
          'assets/images/panda_mascot_green.png',
          fit: BoxFit.contain,
        ),
      ),
    );
