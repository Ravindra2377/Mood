...
void main() {
  ...
  group('🎨 Navigation & UI System Tests', () {
    ...
    testWidgets('IndexedStack preserves state when switching tabs',
        (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(home: ImprovedHomeScreen()),
    ...
    testWidgets('Theme switch toggles between light and dark modes',
        (tester) async {
      ...
      expect(
        Theme.of(scaffoldElementLight).brightness,
      ...
      expect(
        Theme.of(scaffoldElementDark).brightness,
        isNotNull,
      ); // presence sanity
    ...
    testWidgets('Navigation maintains scroll position when switching tabs',
        (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(home: ImprovedHomeScreen()),
  ...
  group('🎨 Theme System Tests', () {
    ...
    testWidgets('High contrast theme prevents visibility issues',
        (tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
