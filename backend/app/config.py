...
class Settings(BaseSettings):
    ...
    # Optional data encryption key (Fernet urlsafe base64).
    # If provided, sensitive fields (e.g., journal content) will be encrypted at rest.
    # If omitted, plaintext is used.
