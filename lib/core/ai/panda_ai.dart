...
/// Represents the emotional tone the panda companion reflects back to the user.
enum PandaMood {
  welcome,
  happy,
  calm,
...
/// Lightweight AI helper that selects nurturing copy for the panda companion.
class PandaAI {
  ...
  final Map<PandaMood, List<String>> _responses = {
    PandaMood.welcome: [
      ...
      "Hi friend! I kept your favourite breathing exercise handy.",
  ...
  /// Returns an uplifting message tuned for the current [mood].
  ...
  /// Returns a message tailored to the active panda [persona] and display [name].
