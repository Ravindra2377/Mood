      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Give your companion a nickname and pick the vibe that fits you today.',
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  ...
                  borderSide:
                      BorderSide(color: AppColors.mediumGrey.withOpacity(0.4)),
                ),
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(16),
                  borderSide:
                      BorderSide(color: AppColors.primaryPastel, width: 2),
                ),
